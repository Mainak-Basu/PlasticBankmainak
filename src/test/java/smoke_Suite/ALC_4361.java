...
public void createdata() throws IOException {
	...
	public void doTransactions() throws InterruptedException {
		...
		pbt.memberToBranchDonation(PostmanNewman.values_ALC_4361.get(1));
		PB_LoginPage pblogin1 = new PB_LoginPage(pbDriver);
		pblogin1.login(PostmanNewman.values_ALC_4361.get(4), password);
		PB_Transaction pbt1 = new PB_Transaction(pbDriver);
		pbt1.branchToProcessorDonation(PostmanNewman.values_ALC_4361.get(2));
}
